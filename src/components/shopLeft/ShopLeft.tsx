                            ...
                            <div className='md:w-[300px]'>
                                <div className='flex gap-4 items-center'>
                                    {leftIcon.map((icon, index) => (
                                        <Link href={item.link} key={index} className='text-navy'>{icon.icon}</Link>
                                    ))}
                                </div>
                            </div>
                        </div>
...
const shopLeftData = [
    {
      ...
      link: "/some-page"  // Make sure this is a valid URL string
    },
    {
      image: "/path/to/another-image.jpg",
      link: "/another-page"  // Make sure this is a valid URL string
    },
    // Add more objects with valid links and images
  ];
