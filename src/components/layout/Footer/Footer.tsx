...
const Footer = () => {
    ...
    const footerIcon = [
        {
            icon: <FaFacebookF />,
            link: "https://facebook.com" // Add appropriate links
        },
        {
            icon: <FaInstagram />,
            link: "https://instagram.com" // Add appropriate links
        },
        {
            icon: <FaTwitter />,
            link: "https://twitter.com" // Add appropriate links
        },
    ]
            ...
            <div className='md:flex justify-between md:py-24'>
                <div className='md:w-[402px]'>
                    ...
                    <div className='flex md:mt-8 mt-2'>
                        <input
                            type="search"
                            className="text-left md:w-[63%] pmd:x-10 md:py-1.5 font-normal text-extralight border border-solid border-gray-300 transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                            id="exampleSearch"
                            placeholder="Enter Email Address"
                        />
        ...
        <div className='wrapper2 lg:flex justify-between items-center'>
            ...
            <div className='flex items-center gap-4'>
                {footerIcon.map((item, index) => (
                    <div key={index} className='hidden lg:block bg-navy p-2 h-8 rounded-full'>
                        <Link href={item.link}>
                            {item.icon}
                        </Link>
                    </div>
